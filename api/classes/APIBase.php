...
class APIBase extends Config
{
    public function __construct($HEADERS)
    {
        ...
        /* Check All Param && Check HFH Key  Check  && Check DatabaseConnection*/
    ...
    {
       // var_dump($this->verifiedJwtToken($HEADERS));exit;
    ...
    public function checkDBConnection()
    {
        ...
        try {
            ...
            $this::$masterConn = new PDO("mysql:host=$this->masterConnServer;dbname=$this->masterConnDBName", $this->masterConnUsername, $this->masterConnPassword,
                array(
    ...
    {
        $erpSystemProject = $this->systemProject;
        $erpSystemModuleFunction = $this->systemModuleFunction;
        
        $erpProjectInstance = new $erpSystemProject($HEADERS);
        $erpProjectInstance->$erpSystemModuleFunction();
