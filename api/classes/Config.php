...
class Config
{
    ...
    public $ERPFileElement = 'ERPFileElement';
    public $deleteAttachmentArray = array();
    protected $data = array();
    protected $fcmUrl = "";

    /* Company Setting */
    protected $fcmServerKey = "AAAAzPBywiE:APA91bGRktJ_J58zA1TakAj3FDkztoVZAlJj8dcJotrf1_1b0iAjVJJ4BXw_LhdmV2yrsfY2VCWNGHLun9azVCyMoiMYbYc0J7X45EQj5U5Djg8Vp4Cya4BNYzcVFDnUsdMA43ksmKfT";
    ...
    protected $APIMessage = array(
        ...
        'HFH_MISSING_HEADERS_PARAMS' => "Missing Headers parameter!",
        'HFH_MISSING_SYSTEM_PARAMS' => "Missing systemProject or systemModuleFunction parameter!",
        'HFH_MISSING_BODY_PARAMS' => "Missing body parameter!",
        'HFH_INVALID_SYSTEM_PROJECT' => "Invalid systemProject",
        'HFH_INVALID_SYSTEM_MODULE_FUNCTION' => "Invalid systemModuleFunction",
    ...
    public function __construct($HEADERS)
    {
        ...
        if (empty($_FILES['ERPFileElement'])) {
            $this->isAttachmentUpdate = false;
        } else {
            if ($this->isNotNullOrEmptyOrZero($_FILES['ERPFileElement']['tmp_name'][0])) {
