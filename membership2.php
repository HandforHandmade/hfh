                    ...
                    <div class="card-body">
                        ...
                        <form class="form">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <fieldset class="form-group">
                                        <label class="form-lbl"> Please let us know what kind of work you do? </label>
                                        <textarea name="" class="form-control" rows="4" required="required"
                                                  id="membershipReason"></textarea>
                                    </fieldset>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <fieldset class="form-group">
                                        <label class="form-lbl"> Please let us know the reason for you to become a
                                            member of HFH </label>
                                        <textarea name="" class="form-control" rows="4" required="required"
                                                  id="membershipWork"></textarea>
                                    </fieldset>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <fieldset class="form-group">
                                    <label class="form-lbl">Select2 Multiselect</label>
                                    <select class="form-control select2-multipleselect" multiple="">
                    ...
                    <div class="card-footer">
                        <div class="row">
                            <div style="    margin-bottom: 5px;" class="form-group col-md-12 text-right">
                                <button class="btn btn-danger btn-md" role="button" onclick="addMemberShip()"> Next
                                </button>
                            </div>
                        </div>
                    </div>
...
<script>
        ...
        APICallAjax(sendApiDataObj, function (response) {
            if (response.responseCode == resultOk) {
                for (let i = 0; i < response.result.userMaster.length; i++) {
                    ...
                    $('#membershipWork').val(userMaster.membershipReason);
                }
            }
        });
    }
    ...
    function addMemberShip() {
        ...
        let sendApiDataObj = {
            ...
            'action': 'update',
            'actionType': 'membershipDetails',
            'membershipReason': $('#membershipReason').val(),
            'membershipWork': $('#membershipWork').val(),
            'userId': $('#userId').val(),
        };
