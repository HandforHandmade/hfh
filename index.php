    ...
    <div id="main_slider" class="rev_slider" data-version="5.3.1.6">
        <ul>
            <li data-index="rs-1587" data-transition="fade" data-slotamount="default" data-hideafterloop="0"
                ...
                data-thumb="img/sliders/slider-1.jpg" data-rotate="0" data-saveperformance="off" data-title="Creative"
                ...
                <div class="slider_text_box">
                    ...
                    <div class="tp-caption tp-resizeme secand_text" data-x="['left','left','left','15','15']"
                        ...
                        Textile enthusiasts can look forward to learning the nuances of natural dyeing at the “Natural
            ...
            <li data-index="rs-1588" data-transition="fade" data-slotamount="default" data-hideafterloop="0"
                ...
                <div class="slider_text_box">
                    ...
                    <div class="tp-caption tp-resizeme secand_text" data-x="['left','left','left','15','15']"
                        ...
                        effort, multiple processes and one can only see the end result after all the processes have been
                        completed
                    </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="main_title">
                        ...
                        <p> HFH Foundation was registered on 1st December 2020 under Section 8 (1) of the Companies Act,
                            2013. Mentorship, Collective Action, Knowledge Sharing and Volunteering are fundamental to
                            the work of HFH. </p>
                    </div>
                    <div class="welcome_left_text">
                        <p> Hand for Handmade (HFH) is a network of artisans, designers, NGOs and craft patrons who came
                            together to collectively respond to the havoc created by the 2020 pandemic. Originating from
                            a deep concern for the survival of the
                            craft and handmade industry, HFH initially functioned as an informal social media platform.
                            The network soon proved to be of immense value and relevance. It generated business, enabled
                            sharing of knowledge, experience,
                            and above all became a sounding board to respond to the unprecedented challenges created by
                            the pandemic...</p>
...
<script>
        ...
        APICallAjax(sendApiDataObj, function (response) {
            ...
            if (response.responseCode == resultOk) {
                for (let i = 0; i < response.result.category.length; i++) {
                    ...
                    htmlData += '<img class="img-fluid" style="height: 210px;width: 354px;" src="'+ADMIN_BASE_URL+'resources/img/category/' + category.image + '" alt="">';
                    htmlData += '</div>';
                    ...
                    htmlData += '<a class="pest_btn" href="event-list.php?id='+category.id+'"> Read More </a>';
                    htmlData += '</div>';
                    htmlData += '</div>';
                    htmlData += '</div>';
                }
    ...
    function getfounderAndDirectors() {
        ...
        APICallAjax(sendApiDataObj, function (response) {
            ...
            founderData += '<p>Shibani Dasgupta Jain an alumna of NID and founder of Baaya Design and founder and director of Hand for Handmade Foundation.Our two other directors are Vipul Jain; an alumnus of IIT-K and IIM-A and a serial tech entrepreneur and Architect Chirashree Thakkar; a heritage evangelist and an ardent advocate of conserving India’s handmade heritage</p>';
            founderData += '</div>';
            founderData += '</div>';
            founderData += '</div>';
            if (response.responseCode == resultOk) {
                for (let i = 0; i < response.result.users.length; i++) {
                    ...
                    founderData += '<img style="height: 230px;width: 200px;"  class="img-fluid" src="'+ADMIN_BASE_URL + users.imagePath1 + '" alt="">';
                    founderData += '<ul class="list_style">';
			if(users.twitterLink!=''){
                        founderData += '<li><a href="' + users.twitterLink + '" target="_blank"><i class="fa fa-twitter"></i></a></li>';    
                    }
                    if(users.linkdInLink!=''){
                        founderData += '<li><a href="' + users.linkdInLink + '" target="_blank"><i class="fa fa-linkedin-square"></i></a></li>';
                    }
                    if(users.facebookLink!=''){
                        founderData += '<li><a href="' + users.facebookLink + '" target="_blank"><i class="fa fa-facebook-square"></i></a></li>';
                    }
                    if(users.instagramLink!=''){
                        founderData += '<li><a href="' + users.instagramLink + '" target="_blank"><i class="fa fa-instagram-square"></i></a></li>';
                    }
                    founderData += '</ul>';
                    founderData += '</div>';
                    founderData += '<a href="#">';
