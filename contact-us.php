...
<body>
                            ...
                            <div class="row clearfix">
                                <div class="col-lg-6 col-md-6 column">
                                    <div class="form-group">
                                        <input type="text" name="form_name" id="form_name" class="form-control" value="" placeholder="Name" required="">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 column">
                                    <div class="form-group">
                                        <input type="email" name="form_email" id="form_email" class="form-control required email" value="" placeholder="Email" required="">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 column">
                                    <div class="form-group">
                                        <input type="text" name="form_phone" id="form_phone" class="form-control" value="" placeholder="Phone" required="">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 column">
                                    <div class="form-group">
                                        <input type="text" name="form_subject" id="form_subject" class="form-control" value="" placeholder="Subject" required="">
                                    </div>
                                </div>
                                <div class="col-lg-12 col-md-12 column">
                                    <div class="form-group">
                                        <textarea name="form_message" class="form-control textarea required" placeholder="Message...." id="form_message"></textarea>
                                    </div>
                                    <div class="form-group flex-box">
                                        <div class="submit-btn">
                                            <button class="theme-btn btn-style-one" type="button" data-loading-text="Please wait..." onclick="sendInquiry()"><span>Send Message</span></button>
                                        </div>
                ...
                <div class="col-lg-4">
                    <div class="contact-info-three">
                        <div class="single-info">
                            ...
                            <div class="text"><i style="font-size: 22px; padding-right: 8px;" class="fa fa-map-marker" aria-hidden="true"></i>
    ...
    <div class="google-map">
        <!--Map Canvas-->
        <div class="map-canvas" data-zoom="12" data-lat="-37.817085" data-lng="144.955631" data-type="roadmap" data-hue="#ffc400" data-title="East Newyork" data-icon-path="images/icons/map-marker.png" data-content="<p>P. B: 222. Mid Corner Street, 11201 <br> +224 620 63 09 00 & 11 <br> supportyou@jexixteam.com</p>">
        </div>
    </div>
